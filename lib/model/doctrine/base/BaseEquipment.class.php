...
Doctrine_Manager::getInstance()->bindComponent('Equipment', 'core');
 ...
 * @method Equipment setOwner()     Sets the current record's "owner" value
 * @method Equipment setComment()   Sets the current record's "comment" value
 * @method Equipment setIsLocked()  Sets the current record's "is_locked" value
 * @method Equipment setOwner()     Sets the current record's "Owner" value
 * 
 * @package    core
 * @subpackage model
