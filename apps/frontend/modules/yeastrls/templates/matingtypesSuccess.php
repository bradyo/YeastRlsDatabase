...
<div id="filterDiv" style="margin-top:1em; margin-bottom:1em">
  <form name="filterForm" action="<?php echo url_for('yeast-rls/mating-types') ?>" method="get" >
    <table class="form">
      <tr>
...
<form id="exportForm" name="exportForm" action="<?php echo url_for('yeast-rls/mating-types-export').'?'.url_params() ?>" method="post">
  ...
  <table id="rlsTable" class="dataTable" style="width:100%;">
    <thead>
      <tr>
        ...
        <?php foreach ($matingTypes as $matingType): ?>
          <th colspan="7"><?php echo $matingType ?></th>
        <?php endforeach ?>
        ...
        <?php foreach ($rows as $row): ?>
          <tr>
            ...
            <?php for ($i = 0; $i < 3; $i++): ?>
              ...
              <td>
                <?php if (!empty($row[$offset])): ?>
                  ...
                  <a href="<?php echo url_for('yeast-rls/result').'?id='.$row[$offset] ?>">
            ...
            <td style="text-align:center">
              <a class="preview" href="<?php echo url_for('yeast-rls/plot')
                . '/type/cross_mating_type/filename/survival'.$row[0].'.png' ?>">
                <img src="<?php echo sfConfig::get('sf_relative_url_root') ?>/images/graph.png" border="0px" alt="plot" />
              </a>
            </td>
          </tr>
